...
void prepareVertices(){
	int horizontal_step_count = 250;
	int vertical_step_count = 150;
    triangle_Count = 2 * horizontal_step_count * vertical_step_count;
    ...
    for(int i = 0; i < horizontal_step_count; i++){
        for(int j = 0; j < vertical_step_count; j++){
...
int main(int argc, char * argv[]) {
    ...
    window = glfwCreateWindow(1000, 1000, "Homework3 - Sphere", NULL, NULL);
    ...
    createShaders("hw3_sphere_source/shader.vert","hw3_sphere_source/shader.frag");
